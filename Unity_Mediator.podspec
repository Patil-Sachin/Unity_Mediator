...
s.author       = "Team"
s.platform     = :ios, "11.2"
s.source       = {:git => 'https://bitbucket.org/vdopia/sdkdistribution.git',:tag => '3.1.6'}
...
s.vendored_libraries = "libUnityMediator.a"
s.dependency 'Chocolate_SDK', '~> 1.0.0'
s.dependency 'UnityAds', '~> 2.1.1'
s.requires_arc = true
end
